...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <symbol xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" id="angle-left-1">
            ...
            <div class="swiper-slide h-auto px-2 swiper-slide-active" style="width: 266px; margin-right: 20px;" data-swiper-slide-index="0">
              ...
              <div data-marker-id="59c0c8e33b1527bfe2abaf92" class="w-100 h-100">
                <div class="card h-100 border-0 shadow">
                  ...
                  <div class="card-body d-flex align-items-center">
                    <div class="w-100">
                      <h6 class="card-title"><a href="https://demo.bootstrapious.com/directory/1-1/detail-rooms.html" class="text-decoration-none text-dark">Maguwoharjo</a></h6>
                      <div class="d-flex card-subtitle mb-3">
                        <p class="flex-grow-1 mb-0 text-muted text-sm">Private room</p>
                        <p class="flex-shrink-1 mb-0 card-stars text-xs text-right"><i class="fa fa-star text-warning"></i><i class="fa fa-star text-warning"></i><i class="fa fa-star text-warning"></i><i class="fa fa-star text-warning"></i><i class="fa fa-star text-warning"></i>
                        </p>
            ...
            <div class="swiper-slide h-auto px-2 swiper-slide-next" style="width: 266px; margin-right: 20px;" data-swiper-slide-index="1">
              ...
              <div data-marker-id="59c0c8e322f3375db4d89128" class="w-100 h-100">
                <div class="card h-100 border-0 shadow">
                  ...
                  <div class="card-body d-flex align-items-center">
                    <div class="w-100">
                      <h6 class="card-title"><a href="https://demo.bootstrapious.com/directory/1-1/detail-rooms.html" class="text-decoration-none text-dark">Parangtritis</a></h6>
                      <div class="d-flex card-subtitle mb-3">
                        <p class="flex-grow-1 mb-0 text-muted text-sm">Entire apartment</p>
                        <p class="flex-shrink-1 mb-0 card-stars text-xs text-right"><i class="fa fa-star text-warning"></i><i class="fa fa-star text-warning"></i><i class="fa fa-star text-warning"></i><i class="fa fa-star text-warning"></i><i class="fa fa-star text-gray-300">                                  </i>
                        </p>
            ...
            <div class="swiper-slide h-auto px-2" data-swiper-slide-index="2" style="width: 266px; margin-right: 20px;">
              ...
              <div data-marker-id="59c0c8e3a31e62979bf147c9" class="w-100 h-100">
                <div class="card h-100 border-0 shadow">
                  ...
                  <div class="card-body d-flex align-items-center">
                    <div class="w-100">
                      <h6 class="card-title"><a href="https://demo.bootstrapious.com/directory/1-1/detail-rooms.html" class="text-decoration-none text-dark">Borobudur</a></h6>
                      <div class="d-flex card-subtitle mb-3">
                        <p class="flex-grow-1 mb-0 text-muted text-sm">Entire apartment</p>
                        <p class="flex-shrink-1 mb-0 card-stars text-xs text-right"><i class="fa fa-star text-warning"></i><i class="fa fa-star text-warning"></i><i class="fa fa-star text-warning"></i><i class="fa fa-star text-gray-300">                                  </i><i class="fa fa-star text-gray-300">                                  </i>
                        </p>
            ...
            <div class="swiper-slide h-auto px-2" data-swiper-slide-index="3" style="width: 266px; margin-right: 20px;">
              ...
              <div data-marker-id="59c0c8e3503eb77d487e8082" class="w-100 h-100">
                <div class="card h-100 border-0 shadow">
                  ...
                  <div class="card-body d-flex align-items-center">
                    <div class="w-100">
                      <h6 class="card-title"><a href="https://demo.bootstrapious.com/directory/1-1/detail-rooms.html" class="text-decoration-none text-dark">Taman Siswa</a></h6>
                      <div class="d-flex card-subtitle mb-3">
                        <p class="flex-grow-1 mb-0 text-muted text-sm">Shared room</p>
                        <p class="flex-shrink-1 mb-0 card-stars text-xs text-right"><i class="fa fa-star text-warning"></i><i class="fa fa-star text-warning"></i><i class="fa fa-star text-warning"></i><i class="fa fa-star text-warning"></i><i class="fa fa-star text-gray-300">                                  </i>
                        </p>
            ...
            <div class="swiper-slide h-auto px-2" style="width: 266px; margin-right: 20px;" data-swiper-slide-index="4">
              ...
              <div data-marker-id="59c0c8e39aa2eed0626e485d" class="w-100 h-100">
                <div class="card h-100 border-0 shadow">
                  ...
                  <div class="card-body d-flex align-items-center">
                    <div class="w-100">
                      <h6 class="card-title"><a href="https://demo.bootstrapious.com/directory/1-1/detail-rooms.html" class="text-decoration-none text-dark">Parangkusumo</a></h6>
                      <div class="d-flex card-subtitle mb-3">
                        <p class="flex-grow-1 mb-0 text-muted text-sm">Entire house</p>
                        <p class="flex-shrink-1 mb-0 card-stars text-xs text-right"><i class="fa fa-star text-warning"></i><i class="fa fa-star text-warning"></i><i class="fa fa-star text-warning"></i><i class="fa fa-star text-warning"></i><i class="fa fa-star text-warning"></i>
                        </p>
            ...
            <div class="swiper-slide h-auto px-2 swiper-slide-duplicate-prev" style="width: 266px; margin-right: 20px;" data-swiper-slide-index="5">
              ...
              <div data-marker-id="59c0c8e39aa2edasd626e485d" class="w-100 h-100">
                <div class="card h-100 border-0 shadow">
                  ...
                  <div class="card-body d-flex align-items-center">
                    <div class="w-100">
                      <h6 class="card-title"><a href="https://demo.bootstrapious.com/directory/1-1/detail-rooms.html" class="text-decoration-none text-dark">Malioboro</a></h6>
                      <div class="d-flex card-subtitle mb-3">
                        <p class="flex-grow-1 mb-0 text-muted text-sm">Private room</p>
                        <p class="flex-shrink-1 mb-0 card-stars text-xs text-right"><i class="fa fa-star text-warning"></i><i class="fa fa-star text-warning"></i><i class="fa fa-star text-warning"></i><i class="fa fa-star text-warning"></i><i class="fa fa-star text-gray-300">                                  </i>
                        </p>
    ...
    <section class="py-6 bg-gray-100" style= "margin-top: -200px"> 
      <div class="container">
        <div class="row mb-5">         
        </div>
        <!-- Slider main container-->
    ...
    <section class="py-6 bg-gray-100" style="margin-top : -190px">
      <div class="container">
        <div class="text-center">
          <p class="subtitle text-primary">Testimonials</p>
          <h2 class="mb-5">Their Experiences</h2>
        </div>
        <!-- Slider main container-->
        <div class="swiper-container testimonials-slider testimonials swiper-container-horizontal">
          ...
          <div class="swiper-wrapper pt-2 pb-5" style="transform: translate3d(-1130px, 0px, 0px); transition-duration: 0ms;"><div class="swiper-slide px-3 swiper-slide-duplicate" data-swiper-slide-index="4" style="width: 545px; margin-right: 20px;">
            <div class="testimonial card rounded-lg shadow border-0">
              ...
              <div class="text">
                ...
                <p class="testimonial-text">Hasil foto yang sangat bagus</p><strong>Luna Maya</strong>
              </div>
            </div>
          </div>
          <div class="swiper-slide px-3 swiper-slide-duplicate swiper-slide-prev" style="width: 545px; margin-right: 20px;" data-swiper-slide-index="5">
            <div class="testimonial card rounded-lg shadow border-0">
              ...
              <div class="text">
                <div class="testimonial-quote"><i class="fas fa-quote-right"></i></div>
                <p class="testimonial-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever</p><strong>Luna Maya</strong>
              </div>
            </div>
          </div>
          <!-- Slides-->
          ...
          <div class="swiper-slide px-3 swiper-slide-next" data-swiper-slide-index="1" style="width: 545px; margin-right: 20px;">
            <div class="testimonial card rounded-lg shadow border-0">
              ...
              <div class="text">
                <div class="testimonial-quote"><i class="fas fa-quote-right"></i></div>
                <p class="testimonial-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever</p><strong>Emilia kontesa</strong>
              </div>
            </div>
          </div>
          ...
          <div class="swiper-slide px-3" data-swiper-slide-index="3" style="width: 545px; margin-right: 20px;">
            <div class="testimonial card rounded-lg shadow border-0">
              ...
              <div class="text">
                <div class="testimonial-quote"><i class="fas fa-quote-right"></i></div>
                <p class="testimonial-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever</p><strong>Mario Teguh</strong>
              </div>
            </div>
          </div>
    ...
    <section class="py-6 bg-gray-100" style="margin-top: -190px"> 
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-8">
            <h2>Let Our Local Photographers Capture Your Precious Memories</h2>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-sm-6 mb-4">
            <div class="card shadow border-0 h-100"><a href="https://demo.bootstrapious.com/directory/1-1/post.html"><img src ="<?php echo base_url('').'assets/'?>img/photo-1512917774080-9991f1c4c750.jpg" alt="..." class="img-fluid card-img-top"></a>
              <div class="card-body">
                <h5 class="my-2"><a href="https://demo.bootstrapious.com/directory/1-1/post.html" class="text-dark">200+ Cities Around the Globe and Counting</a></h5>
                <p class="text-gray-500 text-sm my-3"><i class="far fa-clock mr-2"></i>January 16, 2016</p>
                <p class="my-2 text-muted text-sm">We keep adding destinations to match your travel plan. Ping us should you want new destination, we'll get it done for you!</p><a href="https://demo.bootstrapious.com/directory/1-1/post.html" class="btn btn-link pl-0">Read more<i class="fa fa-long-arrow-alt-right ml-2"></i></a>
              </div>
            </div>
          </div>
          <!-- blog item-->
          <div class="col-lg-4 col-sm-6 mb-4">
            <div class="card shadow border-0 h-100"><a href="https://demo.bootstrapious.com/directory/1-1/post.html"><img src ="<?php echo base_url('').'assets/'?>img/photo-1512917774080-9991f1c4c750.jpg" alt="..." class="img-fluid card-img-top"></a>
              <div class="card-body">
                <h5 class="my-2"><a href="https://demo.bootstrapious.com/directory/1-1/post.html" class="text-dark">Professional Photographer that Suits You</a></h5>
                <p class="text-gray-500 text-sm my-3"><i class="far fa-clock mr-2"></i>January 16, 2016</p>
                <p class="my-2 text-muted text-sm">You are in control to select which Professional Photographer that suits your taste to capture the priceless moments</p><a href="https://demo.bootstrapious.com/directory/1-1/post.html" class="btn btn-link pl-0">Read more<i class="fa fa-long-arrow-alt-right ml-2"></i></a>
              </div>
            </div>
          </div>
          <!-- blog item-->
          <div class="col-lg-4 col-sm-6 mb-4">
            <div class="card shadow border-0 h-100"><a href="https://demo.bootstrapious.com/directory/1-1/post.html"><img src ="<?php echo base_url('').'assets/'?>img/photo-1512917774080-9991f1c4c750.jpg" alt="..." class="img-fluid card-img-top"></a>
              <div class="card-body">
                <h5 class="my-2"><a href="https://demo.bootstrapious.com/directory/1-1/post.html" class="text-dark">Personal Assistant for Your Best Experience with us</a></h5>
                <p class="text-gray-500 text-sm my-3"><i class="far fa-clock mr-2"></i>January 16, 2016</p>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-3 col-md-6 mb-5 mb-lg-0">
              <h6 class="text-uppercase text-dark mb-3">Q n A</h6>
            ...
            <div class="col-lg-4">
              <h6 class="text-uppercase text-dark mb-3">Let us contact you</h6>
