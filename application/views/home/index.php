...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <symbol xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" id="angle-left-1">
    ...
    <header class="header">
      ...
      <nav class="navbar navbar-expand-lg fixed-top shadow navbar-light bg-white">
        <div class="container-fluid">
          <div class="d-flex align-items-center"><a href="https://demo.bootstrapious.com/directory/1-1/index.html" class="navbar-brand py-1"><img src="<?php echo base_url('').'assets/'?>img/logo.svg" alt="Directory logo"></a>
          ...
          <div id="navbarCollapse" class="collapse navbar-collapse">
            ...
            <ul class="navbar-nav ml-auto">
              <li class="megamenu-list-item"><a href=" "  aria-expanded="false" class="nav-link active"> Home</a>
              </li>
              <!-- Megamenu-->
              <li class="nav-item dropdown position-static"><a href="https://demo.bootstrapious.com/directory/1-1/index.html#" data-toggle="dropdown" class="nav-link dropdown-toggle" aria-expanded="false">Category</a>
                <div class="dropdown-menu megamenu py-lg-0" style="display: none; transform: translateY(30px);">
                  <div class="row">
                    <div class="col-lg-9">
                      <div class="row p-3 pr-lg-0 pl-lg-5 pt-lg-5">
                        <div class="col-lg-3">
                          ...
                          <ul class="megamenu-list list-unstyled">
                            <li class="megamenu-list-item"><a href="https://demo.bootstrapious.com/directory/1-1/index.html" class="megamenu-list-link">Rooms   </a></li>
                            <li class="megamenu-list-item"><a href="https://demo.bootstrapious.com/directory/1-1/index-2.html" class="megamenu-list-link">Restaurants   </a></li>
                          </ul>
                          <!-- Megamenu list-->
                          <h6 class="text-uppercase">Restaurants</h6>
                          <ul class="megamenu-list list-unstyled">
                            <li class="megamenu-list-item"><a href="https://demo.bootstrapious.com/directory/1-1/category.html" class="megamenu-list-link">Category - Map on the top   </a></li>
                            <li class="megamenu-list-item"><a href="https://demo.bootstrapious.com/directory/1-1/category-2.html" class="megamenu-list-link">Category - Map on the right   </a></li>
                            <li class="megamenu-list-item"><a href="https://demo.bootstrapious.com/directory/1-1/category-3.html" class="megamenu-list-link">Category - no map   </a></li>
                            <li class="megamenu-list-item"><a href="https://demo.bootstrapious.com/directory/1-1/detail.html" class="megamenu-list-link">Restaurant detail   </a></li>
                          </ul>
                        </div>
                        <div class="col-lg-3">
                          <!-- Megamenu list-->
                          ...
                          <ul class="megamenu-list list-unstyled">
                            <li class="megamenu-list-item"><a href="https://demo.bootstrapious.com/directory/1-1/category-rooms.html" class="megamenu-list-link">Category - Map on the top   </a></li>
                            <li class="megamenu-list-item"><a href="https://demo.bootstrapious.com/directory/1-1/category-2-rooms.html" class="megamenu-list-link">Category - Map on the right   </a></li>
                            <li class="megamenu-list-item"><a href="https://demo.bootstrapious.com/directory/1-1/category-3-rooms.html" class="megamenu-list-link">Category - no map   </a></li>
                            <li class="megamenu-list-item"><a href="https://demo.bootstrapious.com/directory/1-1/detail-rooms.html" class="megamenu-list-link">Room detail   </a></li>
                          </ul>
                          <!-- Megamenu list-->
                          <h6 class="text-uppercase">Blog</h6>
                          <ul class="megamenu-list list-unstyled">
                            <li class="megamenu-list-item"><a href="https://demo.bootstrapious.com/directory/1-1/blog.html" class="megamenu-list-link">Blog   </a></li>
                            <li class="megamenu-list-item"><a href="https://demo.bootstrapious.com/directory/1-1/post.html" class="megamenu-list-link">Post   </a></li>
                          </ul>
                        </div>
                        <div class="col-lg-3">
                          <!-- Megamenu list-->
                          ...
                          <ul class="megamenu-list list-unstyled">
                            <li class="megamenu-list-item"><a href="https://demo.bootstrapious.com/directory/1-1/contact.html" class="megamenu-list-link">Contact   </a></li>
                            <li class="megamenu-list-item"><a href="https://demo.bootstrapious.com/directory/1-1/pricing.html" class="megamenu-list-link">Pricing   </a></li>
                            <li class="megamenu-list-item"><a href="https://demo.bootstrapious.com/directory/1-1/text.html" class="megamenu-list-link">Text page   </a></li>
                            <li class="megamenu-list-item"><a href="https://demo.bootstrapious.com/directory/1-1/faq.html" class="megamenu-list-link">F.A.Q.s  <span class="badge badge-info ml-1">New</span>   </a></li>
                            <li class="megamenu-list-item"><a href="https://demo.bootstrapious.com/directory/1-1/coming-soon.html" class="megamenu-list-link">Coming soon   </a></li>
                          </ul>
                          <!-- Megamenu list-->
                          <h6 class="text-uppercase">User</h6>
                          <ul class="megamenu-list list-unstyled">
                            <li class="megamenu-list-item"><a href="https://demo.bootstrapious.com/directory/1-1/user-add-0.html" class="megamenu-list-link">Add new listing  - 6 pages <span class="badge badge-warning ml-1">New</span>   </a></li>
                            <li class="megamenu-list-item"><a href="https://demo.bootstrapious.com/directory/1-1/login.html" class="megamenu-list-link">Sign in   </a></li>
                            <li class="megamenu-list-item"><a href="https://demo.bootstrapious.com/directory/1-1/signup.html" class="megamenu-list-link">Sign up   </a></li>
                          </ul>
                        </div>
                        <div class="col-lg-3">
                          <!-- Megamenu list-->
                          ...
                          <ul class="megamenu-list list-unstyled">
                            <li class="megamenu-list-item"><a href="https://demo.bootstrapious.com/directory/1-1/docs/docs-introduction.html" class="megamenu-list-link">Introduction   </a></li>
                            <li class="megamenu-list-item"><a href="https://demo.bootstrapious.com/directory/1-1/docs/docs-directory-structure.html" class="megamenu-list-link">Directory structure   </a></li>
                            <li class="megamenu-list-item"><a href="https://demo.bootstrapious.com/directory/1-1/docs/docs-gulp.html" class="megamenu-list-link">Gulp   </a></li>
                            <li class="megamenu-list-item"><a href="https://demo.bootstrapious.com/directory/1-1/docs/docs-customizing-css.html" class="megamenu-list-link">Customizing CSS   </a></li>
                            <li class="megamenu-list-item"><a href="https://demo.bootstrapious.com/directory/1-1/docs/docs-credits.html" class="megamenu-list-link">Credits   </a></li>
                            <li class="megamenu-list-item"><a href="https://demo.bootstrapious.com/directory/1-1/docs/docs-changelog.html" class="megamenu-list-link">Changelog   </a></li>
                          </ul>
                          <!-- Megamenu list-->
                          <h6 class="text-uppercase">Components</h6>
                          <ul class="megamenu-list list-unstyled">
                            <li class="megamenu-list-item"><a href="https://demo.bootstrapious.com/directory/1-1/docs/components-bootstrap.html" class="megamenu-list-link">Bootstrap   </a></li>
                            <li class="megamenu-list-item"><a href="https://demo.bootstrapious.com/directory/1-1/docs/components-directory.html" class="megamenu-list-link">Theme   </a></li>
                          </ul>
                        </div>
                      </div>
                    ...
                    <div class="col-lg-3 d-none d-lg-block"><img src="<?php echo base_url('').'assets/'?>img/photo-1521170665346-3f21e2291d8b.jpg" alt="" class="bg-image"></div>
                  </div>
                </div>
              </li>
              <!-- /Megamenu end-->
              <li class="nav-item"><a href="https://demo.bootstrapious.com/directory/1-1/contact.html" class="nav-link">Blog</a>
              </li>
              <li class="nav-item"><a href="https://demo.bootstrapious.com/directory/1-1/contact.html" class="nav-link">Gallery</a>
              </li>
              <li class="nav-item"><a href="https://demo.bootstrapious.com/directory/1-1/signup.html" class="nav-link">Sign up</a></li>
              <li class="nav-item mt-3 mt-lg-0 ml-lg-3 d-lg-none d-xl-inline-block"><a href="https://demo.bootstrapious.com/directory/1-1/user-add-0.html" class="btn btn-primary">Login</a></li>
            </ul>
          </div>
        </div>
      </nav>
      ...
      <div class="container py-6 py-md-7 text-white z-index-20">
        <div class="row">
            <div class="col-xl-10">
                ...
                <h1 class="display-3 font-weight-bold text-shadow h1-border-bottom text-white">Stay like a local</h1>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="search-bar ml-4 mt-5 p-3 p-lg-1 pl-lg-4">
              <form action="https://demo.bootstrapious.com/directory/1-1/index.html#">
                <div class="row">
    ...
    <section class="py-6 bg-gray-100"> 
      <div class="container">
        ...
        <div data-swiper="{&quot;slidesPerView&quot;:4,&quot;spaceBetween&quot;:20,&quot;loop&quot;:true,&quot;roundLengths&quot;:true,&quot;breakpoints&quot;:{&quot;1200&quot;:{&quot;slidesPerView&quot;:3},&quot;991&quot;:{&quot;slidesPerView&quot;:2},&quot;565&quot;:{&quot;slidesPerView&quot;:1}},&quot;pagination&quot;:{&quot;el&quot;:&quot;.swiper-pagination&quot;,&quot;clickable&quot;:true,&quot;dynamicBullets&quot;:true}}" class="swiper-container swiper-container-mx-negative swiper-init swiper-container-horizontal">
          <!-- Additional required wrapper-->
          <div class="swiper-wrapper pb-5" style="transform: translate3d(-1144px, 0px, 0px); transition-duration: 0ms;"><div class="swiper-slide h-auto px-2 swiper-slide-duplicate" data-swiper-slide-index="2" style="width: 266px; margin-right: 20px;">
              <!-- place item-->
              <div data-marker-id="59c0c8e3a31e62979bf147c9" class="w-100 h-100">
                <div class="card h-100 border-0 shadow">
                  <div class="card-img-top overflow-hidden gradient-overlay"> <img src ="<?php echo base_url('').'assets/'?>img/photo-1512917774080-9991f1c4c750.jpg" alt="Modern Apt - Vibrant Neighborhood!" class="img-fluid"><a href="https://demo.bootstrapious.com/directory/1-1/detail-rooms.html" class="tile-link"></a>
                    <div class="card-img-overlay-bottom z-index-20">
                      <div class="media text-white text-sm align-items-center"><img src ="<?php echo base_url('').'assets/'?>img/avatar-8.jpg" alt="Julie" class="avatar avatar-border-white mr-2">
                  ...
                  <div class="card-body d-flex align-items-center">
                    <div class="w-100">
                      <h6 class="card-title"><a href="https://demo.bootstrapious.com/directory/1-1/detail-rooms.html" class="text-decoration-none text-dark">Modern Apt - Vibrant Neighborhood!</a></h6>
            ...
            </div><div class="swiper-slide h-auto px-2 swiper-slide-duplicate" data-swiper-slide-index="3" style="width: 266px; margin-right: 20px;">
              <!-- place item-->
              <div data-marker-id="59c0c8e3503eb77d487e8082" class="w-100 h-100">
                <div class="card h-100 border-0 shadow">
                  <div class="card-img-top overflow-hidden gradient-overlay"> <img src ="<?php echo base_url('').'assets/'?>img/photo-1494526585095-c41746248156.jpg" alt="Sunny Private Studio-Apartment" class="img-fluid"><a href="https://demo.bootstrapious.com/directory/1-1/detail-rooms.html" class="tile-link"></a>
                    <div class="card-img-overlay-bottom z-index-20">
                      <div class="media text-white text-sm align-items-center"><img src ="<?php echo base_url('').'assets/'?>img/avatar-9.jpg" alt="Barbora" class="avatar avatar-border-white mr-2">
                  ...
                  <div class="card-body d-flex align-items-center">
                    <div class="w-100">
                      <h6 class="card-title"><a href="https://demo.bootstrapious.com/directory/1-1/detail-rooms.html" class="text-decoration-none text-dark">Sunny Private Studio-Apartment</a></h6>
                      <div class="d-flex card-subtitle mb-3">
            ...
            </div><div class="swiper-slide h-auto px-2 swiper-slide-duplicate" style="width: 266px; margin-right: 20px;" data-swiper-slide-index="4">
              <!-- place item-->
              <div data-marker-id="59c0c8e39aa2eed0626e485d" class="w-100 h-100">
                <div class="card h-100 border-0 shadow">
                  <div class="card-img-top overflow-hidden gradient-overlay"> <img src ="<?php echo base_url('').'assets/'?>img/photo-1522771739844-6a9f6d5f14af.jpg" alt="Mid-Century Modern Garden Paradise" class="img-fluid"><a href="https://demo.bootstrapious.com/directory/1-1/detail-rooms.html" class="tile-link"></a>
                    <div class="card-img-overlay-bottom z-index-20">
                      <div class="media text-white text-sm align-items-center"><img src ="<?php echo base_url('').'assets/'?>img/avatar-10.jpg" alt="Jack" class="avatar avatar-border-white mr-2">
                  ...
                  <div class="card-body d-flex align-items-center">
                    <div class="w-100">
                      <h6 class="card-title"><a href="https://demo.bootstrapious.com/directory/1-1/detail-rooms.html" class="text-decoration-none text-dark">Mid-Century Modern Garden Paradise</a></h6>
                      <div class="d-flex card-subtitle mb-3">
            ...
            </div><div class="swiper-slide h-auto px-2 swiper-slide-duplicate swiper-slide-prev" style="width: 266px; margin-right: 20px;" data-swiper-slide-index="5">
              <!-- place item-->
              <div data-marker-id="59c0c8e39aa2edasd626e485d" class="w-100 h-100">
                <div class="card h-100 border-0 shadow">
                  <div class="card-img-top overflow-hidden gradient-overlay"> <img src ="<?php echo base_url('').'assets/'?>img/photo-1488805990569-3c9e1d76d51c.jpg" alt="Brooklyn Life, Easy to Manhattan" class="img-fluid"><a href="https://demo.bootstrapious.com/directory/1-1/detail-rooms.html" class="tile-link"></a>
                    <div class="card-img-overlay-bottom z-index-20">
                      <div class="media text-white text-sm align-items-center"><img src ="<?php echo base_url('').'assets/'?>img/avatar-11.jpg" alt="Stuart" class="avatar avatar-border-white mr-2">
                  ...
                  <div class="card-body d-flex align-items-center">
                    <div class="w-100">
                      <h6 class="card-title"><a href="https://demo.bootstrapious.com/directory/1-1/detail-rooms.html" class="text-decoration-none text-dark">Brooklyn Life, Easy to Manhattan</a></h6>
                      <div class="d-flex card-subtitle mb-3">
            ...
            <!-- Slides-->
            <div class="swiper-slide h-auto px-2 swiper-slide-active" style="width: 266px; margin-right: 20px;" data-swiper-slide-index="0">
              <!-- place item-->
              <div data-marker-id="59c0c8e33b1527bfe2abaf92" class="w-100 h-100">
                <div class="card h-100 border-0 shadow">
                  <div class="card-img-top overflow-hidden gradient-overlay"> <img src ="<?php echo base_url('').'assets/'?>img/photo-1484154218962-a197022b5858.jpg" alt="Modern, Well-Appointed Room" class="img-fluid"><a href="https://demo.bootstrapious.com/directory/1-1/detail-rooms.html" class="tile-link"></a>
                    <div class="card-img-overlay-bottom z-index-20">
                      <div class="media text-white text-sm align-items-center"><img src ="<?php echo base_url('').'assets/'?>img/avatar-0.jpg" alt="Pamela" class="avatar avatar-border-white mr-2">
                  ...
                  <div class="card-body d-flex align-items-center">
                    <div class="w-100">
                      <h6 class="card-title"><a href="https://demo.bootstrapious.com/directory/1-1/detail-rooms.html" class="text-decoration-none text-dark">Modern, Well-Appointed Room</a></h6>
                      <div class="d-flex card-subtitle mb-3">
                        <p class="flex-grow-1 mb-0 text-muted text-sm">Private room</p>
                        <p class="flex-shrink-1 mb-0 card-stars text-xs text-right"><i class="fa fa-star text-warning"></i><i class="fa fa-star text-warning"></i><i class="fa fa-star text-warning"></i><i class="fa fa-star text-warning"></i><i class="fa fa-star text-warning"></i>
                        </p>
            ...
            <div class="swiper-slide h-auto px-2 swiper-slide-next" style="width: 266px; margin-right: 20px;" data-swiper-slide-index="1">
              <!-- place item-->
              <div data-marker-id="59c0c8e322f3375db4d89128" class="w-100 h-100">
                <div class="card h-100 border-0 shadow">
                  <div class="card-img-top overflow-hidden gradient-overlay"> <img src ="<?php echo base_url('').'assets/'?>img/photo-1426122402199-be02db90eb90.jpg" alt="Cute Quirky Garden apt, NYC adjacent" class="img-fluid"><a href="https://demo.bootstrapious.com/directory/1-1/detail-rooms.html" class="tile-link"></a>
                    <div class="card-img-overlay-bottom z-index-20">
                      <div class="media text-white text-sm align-items-center"><img src ="<?php echo base_url('').'assets/'?>img/avatar-7.jpg" alt="John" class="avatar avatar-border-white mr-2">
                  ...
                  <div class="card-body d-flex align-items-center">
                    <div class="w-100">
                      <h6 class="card-title"><a href="https://demo.bootstrapious.com/directory/1-1/detail-rooms.html" class="text-decoration-none text-dark">Cute Quirky Garden apt, NYC adjacent</a></h6>
                      <div class="d-flex card-subtitle mb-3">
                        <p class="flex-grow-1 mb-0 text-muted text-sm">Entire apartment</p>
                        <p class="flex-shrink-1 mb-0 card-stars text-xs text-right"><i class="fa fa-star text-warning"></i><i class="fa fa-star text-warning"></i><i class="fa fa-star text-warning"></i><i class="fa fa-star text-warning"></i><i class="fa fa-star text-gray-300">                                  </i>
                        </p>
            ...
            <div class="swiper-slide h-auto px-2" data-swiper-slide-index="2" style="width: 266px; margin-right: 20px;">
              <!-- place item-->
              <div data-marker-id="59c0c8e3a31e62979bf147c9" class="w-100 h-100">
                <div class="card h-100 border-0 shadow">
                  <div class="card-img-top overflow-hidden gradient-overlay"> <img src ="<?php echo base_url('').'assets/'?>img/photo-1512917774080-9991f1c4c750.jpg" alt="Modern Apt - Vibrant Neighborhood!" class="img-fluid"><a href="https://demo.bootstrapious.com/directory/1-1/detail-rooms.html" class="tile-link"></a>
            ...
            <div class="swiper-slide h-auto px-2" data-swiper-slide-index="3" style="width: 266px; margin-right: 20px;">
              <!-- place item-->
              <div data-marker-id="59c0c8e3503eb77d487e8082" class="w-100 h-100">
                <div class="card h-100 border-0 shadow">
                  <div class="card-img-top overflow-hidden gradient-overlay"> <img src ="<?php echo base_url('').'assets/'?>img/photo-1494526585095-c41746248156.jpg" alt="Sunny Private Studio-Apartment" class="img-fluid"><a href="https://demo.bootstrapious.com/directory/1-1/detail-rooms.html" class="tile-link"></a>
            ...
            <div class="swiper-slide h-auto px-2" style="width: 266px; margin-right: 20px;" data-swiper-slide-index="4">
              <!-- place item-->
              <div data-marker-id="59c0c8e39aa2eed0626e485d" class="w-100 h-100">
                <div class="card h-100 border-0 shadow">
                  <div class="card-img-top overflow-hidden gradient-overlay"> <img src ="<?php echo base_url('').'assets/'?>img/photo-1522771739844-6a9f6d5f14af.jpg" alt="Mid-Century Modern Garden Paradise" class="img-fluid"><a href="https://demo.bootstrapious.com/directory/1-1/detail-rooms.html" class="tile-link"></a>
            ...
            <div class="swiper-slide h-auto px-2 swiper-slide-duplicate-prev" style="width: 266px; margin-right: 20px;" data-swiper-slide-index="5">
              <!-- place item-->
              <div data-marker-id="59c0c8e39aa2edasd626e485d" class="w-100 h-100">
                <div class="card h-100 border-0 shadow">
                  <div class="card-img-top overflow-hidden gradient-overlay"> <img src ="<?php echo base_url('').'assets/'?>img/photo-1488805990569-3c9e1d76d51c.jpg" alt="Brooklyn Life, Easy to Manhattan" class="img-fluid"><a href="https://demo.bootstrapious.com/directory/1-1/detail-rooms.html" class="tile-link"></a>
          ...
          <div class="swiper-slide h-auto px-2 swiper-slide-duplicate swiper-slide-duplicate-active" style="width: 266px; margin-right: 20px;" data-swiper-slide-index="0">
              <!-- place item-->
              <div data-marker-id="59c0c8e33b1527bfe2abaf92" class="w-100 h-100">
                <div class="card h-100 border-0 shadow">
                  <div class="card-img-top overflow-hidden gradient-overlay"> <img src ="<?php echo base_url('').'assets/'?>img/photo-1484154218962-a197022b5858.jpg" alt="Modern, Well-Appointed Room" class="img-fluid"><a href="https://demo.bootstrapious.com/directory/1-1/detail-rooms.html" class="tile-link"></a>
            ...
            </div><div class="swiper-slide h-auto px-2 swiper-slide-duplicate swiper-slide-duplicate-next" style="width: 266px; margin-right: 20px;" data-swiper-slide-index="1">
              <!-- place item-->
              <div data-marker-id="59c0c8e322f3375db4d89128" class="w-100 h-100">
                <div class="card h-100 border-0 shadow">
                  <div class="card-img-top overflow-hidden gradient-overlay"> <img src ="<?php echo base_url('').'assets/'?>img/photo-1426122402199-be02db90eb90.jpg" alt="Cute Quirky Garden apt, NYC adjacent" class="img-fluid"><a href="https://demo.bootstrapious.com/directory/1-1/detail-rooms.html" class="tile-link"></a>
            ...
            </div><div class="swiper-slide h-auto px-2 swiper-slide-duplicate" data-swiper-slide-index="2" style="width: 266px; margin-right: 20px;">
              <!-- place item-->
              <div data-marker-id="59c0c8e3a31e62979bf147c9" class="w-100 h-100">
                <div class="card h-100 border-0 shadow">
                  <div class="card-img-top overflow-hidden gradient-overlay"> <img src ="<?php echo base_url('').'assets/'?>img/photo-1512917774080-9991f1c4c750.jpg" alt="Modern Apt - Vibrant Neighborhood!" class="img-fluid"><a href="https://demo.bootstrapious.com/directory/1-1/detail-rooms.html" class="tile-link"></a>
    ...
    <!-- Divider Section-->
    <section class="py-7 position-relative dark-overlay"><img src ="<?php echo base_url('').'assets/'?>img/photo-1497436072909-60f360e1d4b1.jpg" alt="" class="bg-image">
      <div class="container">
        <div class="overlay-content text-white py-lg-5">
          <h3 class="display-3 font-weight-bold text-serif text-shadow mb-5">Ready for your next holidays?</h3><a href="https://demo.bootstrapious.com/directory/1-1/category-rooms.html" class="btn btn-light">Get started</a>
        </div>
      </div>
    </section>
    <section class="py-7">
    ...
    <section class="py-6 bg-gray-100"> 
      <div class="container">
        <div class="row mb-5">
          ...
          <div class="col-md-4 d-md-flex align-items-center justify-content-end"><a href="https://demo.bootstrapious.com/directory/1-1/blog.html" class="text-muted text-sm">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-sm-6 mb-4">
            <div class="card shadow border-0 h-100"><a href="https://demo.bootstrapious.com/directory/1-1/post.html"><img src ="<?php echo base_url('').'assets/'?>img/photo-1512917774080-9991f1c4c750.jpg" alt="..." class="img-fluid card-img-top"></a>
              <div class="card-body"><a href="https://demo.bootstrapious.com/directory/1-1/index.html#" class="text-uppercase text-muted text-sm letter-spacing-2">Travel </a>
                <h5 class="my-2"><a href="https://demo.bootstrapious.com/directory/1-1/post.html" class="text-dark">Autumn fashion tips and tricks          </a></h5>
                <p class="text-gray-500 text-sm my-3"><i class="far fa-clock mr-2"></i>January 16, 2016</p>
                <p class="my-2 text-muted text-sm">Pellentesque habitant morbi tristique senectus. Vestibulum tortor quam, feugiat vitae, ultricies ege...</p><a href="https://demo.bootstrapious.com/directory/1-1/post.html" class="btn btn-link pl-0">Read more<i class="fa fa-long-arrow-alt-right ml-2"></i></a>
              </div>
            </div>
          </div>
          <!-- blog item-->
          <div class="col-lg-4 col-sm-6 mb-4">
            <div class="card shadow border-0 h-100"><a href="https://demo.bootstrapious.com/directory/1-1/post.html"><img src ="<?php echo base_url('').'assets/'?>img/photo-1522771739844-6a9f6d5f14af.jpg" alt="..." class="img-fluid card-img-top"></a>
              <div class="card-body"><a href="https://demo.bootstrapious.com/directory/1-1/index.html#" class="text-uppercase text-muted text-sm letter-spacing-2">Living </a>
                <h5 class="my-2"><a href="https://demo.bootstrapious.com/directory/1-1/post.html" class="text-dark">Newest photo apps          </a></h5>
                <p class="text-gray-500 text-sm my-3"><i class="far fa-clock mr-2"></i>January 16, 2016</p>
                <p class="my-2 text-muted text-sm">ellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibu...</p><a href="https://demo.bootstrapious.com/directory/1-1/post.html" class="btn btn-link pl-0">Read more<i class="fa fa-long-arrow-alt-right ml-2"></i></a>
              </div>
            </div>
          </div>
          <!-- blog item-->
          <div class="col-lg-4 col-sm-6 mb-4">
            <div class="card shadow border-0 h-100"><a href="https://demo.bootstrapious.com/directory/1-1/post.html"><img src ="<?php echo base_url('').'assets/'?>img/photo-1482463084673-98272196658a.jpg" alt="..." class="img-fluid card-img-top"></a>
              <div class="card-body"><a href="https://demo.bootstrapious.com/directory/1-1/index.html#" class="text-uppercase text-muted text-sm letter-spacing-2">Travel </a>
                <h5 class="my-2"><a href="https://demo.bootstrapious.com/directory/1-1/post.html" class="text-dark">Best books about Photography          </a></h5>
                <p class="text-gray-500 text-sm my-3"><i class="far fa-clock mr-2"></i>January 16, 2016</p>
                <p class="my-2 text-muted text-sm">Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante.  Mauris placerat eleif...</p><a href="https://demo.bootstrapious.com/directory/1-1/post.html" class="btn btn-link pl-0">Read more<i class="fa fa-long-arrow-alt-right ml-2"></i></a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container-fluid px-0">
        <div class="swiper-container instagram-slider swiper-container-horizontal">
          <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);">
            <div class="swiper-slide overflow-hidden swiper-slide-active" style="width: 134.9px;"><a href="https://demo.bootstrapious.com/directory/1-1/index.html#"><img src ="<?php echo base_url('').'assets/'?>img/instagram-1.jpg" alt="" class="img-fluid hover-scale"></a></div>
            <div class="swiper-slide overflow-hidden swiper-slide-next" style="width: 134.9px;"><a href="https://demo.bootstrapious.com/directory/1-1/index.html#"><img src ="<?php echo base_url('').'assets/'?>img/instagram-2.jpg" alt="" class="img-fluid hover-scale"></a></div>
            <div class="swiper-slide overflow-hidden" style="width: 134.9px;"><a href="https://demo.bootstrapious.com/directory/1-1/index.html#"><img src ="<?php echo base_url('').'assets/'?>img/instagram-3.jpg" alt="" class="img-fluid hover-scale"></a></div>
            <div class="swiper-slide overflow-hidden" style="width: 134.9px;"><a href="https://demo.bootstrapious.com/directory/1-1/index.html#"><img src ="<?php echo base_url('').'assets/'?>img/instagram-4.jpg" alt="" class="img-fluid hover-scale"></a></div>
            <div class="swiper-slide overflow-hidden" style="width: 134.9px;"><a href="https://demo.bootstrapious.com/directory/1-1/index.html#"><img src ="<?php echo base_url('').'assets/'?>img/instagram-5.jpg" alt="" class="img-fluid hover-scale"></a></div>
            <div class="swiper-slide overflow-hidden" style="width: 134.9px;"><a href="https://demo.bootstrapious.com/directory/1-1/index.html#"><img src ="<?php echo base_url('').'assets/'?>img/instagram-6.jpg" alt="" class="img-fluid hover-scale"></a></div>
            <div class="swiper-slide overflow-hidden" style="width: 134.9px;"><a href="https://demo.bootstrapious.com/directory/1-1/index.html#"><img src ="<?php echo base_url('').'assets/'?>img/instagram-7.jpg" alt="" class="img-fluid hover-scale"></a></div>
            <div class="swiper-slide overflow-hidden" style="width: 134.9px;"><a href="https://demo.bootstrapious.com/directory/1-1/index.html#"><img src ="<?php echo base_url('').'assets/'?>img/instagram-8.jpg" alt="" class="img-fluid hover-scale"></a></div>
            <div class="swiper-slide overflow-hidden" style="width: 134.9px;"><a href="https://demo.bootstrapious.com/directory/1-1/index.html#"><img src ="<?php echo base_url('').'assets/'?>img/instagram-9.jpg" alt="" class="img-fluid hover-scale"></a></div>
            <div class="swiper-slide overflow-hidden" style="width: 134.9px;"><a href="https://demo.bootstrapious.com/directory/1-1/index.html#"><img src ="<?php echo base_url('').'assets/'?>img/instagram-10.jpg" alt="" class="img-fluid hover-scale"></a></div>
            <div class="swiper-slide overflow-hidden" style="width: 134.9px;"><a href="https://demo.bootstrapious.com/directory/1-1/index.html#"><img src ="<?php echo base_url('').'assets/'?>img/instagram-11.jpg" alt="" class="img-fluid hover-scale"></a></div>
            <div class="swiper-slide overflow-hidden" style="width: 134.9px;"><a href="https://demo.bootstrapious.com/directory/1-1/index.html#"><img src ="<?php echo base_url('').'assets/'?>img/instagram-12.jpg" alt="" class="img-fluid hover-scale"></a></div>
            <div class="swiper-slide overflow-hidden" style="width: 134.9px;"><a href="https://demo.bootstrapious.com/directory/1-1/index.html#"><img src ="<?php echo base_url('').'assets/'?>img/instagram-13.jpg" alt="" class="img-fluid hover-scale"></a></div>
            <div class="swiper-slide overflow-hidden" style="width: 134.9px;"><a href="https://demo.bootstrapious.com/directory/1-1/index.html#"><img src ="<?php echo base_url('').'assets/'?>img/instagram-14.jpg" alt="" class="img-fluid hover-scale"></a></div>
          </div>
        <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span></div>
      </div>
    </section>
          ...
          <div class="row">
            ...
            <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
              ...
              <ul class="list-unstyled">
                <li><a href="https://demo.bootstrapious.com/directory/1-1/index.html" class="text-muted">Rooms     </a></li>
                <li><a href="https://demo.bootstrapious.com/directory/1-1/category-rooms.html" class="text-muted">Map on top     </a></li>
                <li><a href="https://demo.bootstrapious.com/directory/1-1/category-2-rooms.html" class="text-muted">Side map     </a></li>
                <li><a href="https://demo.bootstrapious.com/directory/1-1/category-3-rooms.html" class="text-muted">No map     </a></li>
                <li><a href="https://demo.bootstrapious.com/directory/1-1/detail-rooms.html" class="text-muted">Room detail     </a></li>
              </ul>
            </div>
            <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
            ...
            <div class="col-lg-4">
              ...
              <form action="https://demo.bootstrapious.com/directory/1-1/index.html#" id="newsletter-form">
